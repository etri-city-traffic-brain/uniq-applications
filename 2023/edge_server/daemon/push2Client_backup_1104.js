...
const getUuidList = () => {
  return new Promise((resolve, reject) => {
    ...
    // var tableName = "TB_TRACKING_" + moment().format("20210607");
    var queryTime = moment()
      .subtract(1, "minutes")
      .format("YYYY-MM-DD HH:mm:ss");
    var queryTime = moment().format("2021-06-07 00:00:00");
...
const insertPushInfo = (uuid, message) => {
  return new Promise((resolve, reject) => {
    var params = {
      uuid,
